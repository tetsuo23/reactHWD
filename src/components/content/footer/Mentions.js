      ...
      <div className="mentions">
        ...
        <p>
          ...
          <p>
            ...
            <a href="http://horizonwebdesign.fr/">horizonwebdesign.fr</a>{" "}
            l'identité des différents intervenants dans le cadre de sa
            réalisation et de son suivi :
          </p>
          <p>
            <strong>Propriétaire</strong> : Garnavault – 41414577100021 – 1
            impasse des tilleuls 16300 saint-bonnet
            <br />
            <strong>Créateur</strong> :{" "}
            <a href="https://horizonwebdesign.fr">Michaud</a>
            <br />
            <strong>Responsable publication</strong> : Michaud –
            horizon.w.design@gmail.com
            <br />
            Le responsable publication est une personne physique ou une personne
            morale.
            <br />
            <strong>Webmaster</strong> : Michaud –
            horizonwebdeveloppement@gmail.com
            <br />
            <strong>Hébergeur</strong> : firebase – 1600 Amphitheatre Parkway,
            Mountain View, California 94043, USA
            <br />
            Crédits : Michaud, Garnavault
            <br />
          ...
          <p>
            ...
            utilisateurs du site{" "}
            <a href="http://horizonwebdesign.fr/">horizonwebdesign.fr</a> sont
          ...
          <p>
            ...
            toutefois décidée par Garnavault, qui s’efforcera alors de
            communiquer préalablement aux utilisateurs les dates et heures de
            l’intervention.
          </p>
          <p>
            Le site{" "}
            <a href="http://horizonwebdesign.fr/">horizonwebdesign.fr</a> est
            mis à jour régulièrement par Michaud. De la même façon, les mentions
          ...
          <p>
            Le site{" "}
            <a href="http://horizonwebdesign.fr/">horizonwebdesign.fr</a> a pour
            objet de fournir une information concernant l’ensemble des activités
            de la société.
          </p>
          <p>
            Garnavault s’efforce de fournir sur le site{" "}
            <a href="http://horizonwebdesign.fr/">horizonwebdesign.fr</a> des
          ...
          <p>
            ...
            <a href="http://horizonwebdesign.fr/">horizonwebdesign.fr</a> ne
          ...
          <p>
            Garnavault est propriétaire des droits de propriété intellectuelle
          ...
          <p>
            Garnavault ne pourra être tenue responsable des dommages directs et
            indirects causés au matériel de l’utilisateur, lors de l’accès au
            site horizonwebdesign.fr, et résultant soit de l’utilisation d’un
            matériel ne répondant pas aux spécifications indiquées au point 4,
            soit de l’apparition d’un bug ou d’une incompatibilité.
          </p>
          <p>
            Garnavault ne pourra également être tenue responsable des dommages
          ...
          <p>
            ...
            l’espace contact) sont à la disposition des utilisateurs. Garnavault
            ...
            relatives à la protection des données. Le cas échéant, Garnavault se
          ...
          <p>
            ...
            <a href="http://horizonwebdesign.fr/">horizonwebdesign.fr</a>, le
            fournisseur d'accès de l'utilisateur, l'adresse de protocole
            Internet (IP) de l'utilisateur.
          </p>
          <p>
            {" "}
            En tout état de cause Garnavault ne collecte des informations
          ...
          <p>
            ...
            <a href="http://horizonwebdesign.fr/">horizonwebdesign.fr</a> n'est
            ...
            rachat de Garnavault et de ses droits permettrait la transmission
          ...
          <p>
            ...
            mis en place avec l’autorisation de Garnavault. Cependant,
            Garnavault n’a pas la possibilité de vérifier le contenu des sites
